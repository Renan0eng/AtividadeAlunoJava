...
public class NewJDialog extends javax.swing.JDialog {
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        String text = resultado.getText();
        
        Double resultadoCalculo = 0d;
        ...
        for(StringTokenizer stringTokenizer = new StringTokenizer(text); stringTokenizer.hasMoreTokens();){
            ...
            if(token.equals("/") || token.equals("*") || token.equals("-") || token.equals("+")){
                ...
                resultadoCalculo = Double.parseDouble(token);
            }else if( operador != null){
                if(operador.equals("/")){
                 resultadoCalculo = resultadoCalculo / Double.parseDouble(token);
        ...
        resultado.setText(resultadoCalculo.toString());
